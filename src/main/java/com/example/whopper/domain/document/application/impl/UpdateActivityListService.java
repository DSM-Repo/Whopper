...
@Service
public class UpdateActivityListService extends AbstractUpdateElementServiceBase<List<UpdateActivityElementRequest>> implements UpdateActivityListUseCase {
    ...
    @Override
    protected void updateDocument(DocumentEntity document, List<UpdateActivityElementRequest> list) {
