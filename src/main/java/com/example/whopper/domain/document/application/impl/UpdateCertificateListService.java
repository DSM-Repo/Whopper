...
import com.example.whopper.domain.document.application.usecase.UpdateCertificateListUseCase;
...
@Service
public class UpdateCertificateListService extends AbstractUpdateElementServiceBase<List<CertificateElement>> implements UpdateCertificateListUseCase {
