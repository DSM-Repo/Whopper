...
public record ProjectElementDto(String elementId, String name, ImageInfo imageInfo, ProjectType type, String startDate, String endDate, Set<String> skillSet, List<ProjectElement.Section> sections, String url) {
